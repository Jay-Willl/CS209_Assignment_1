...
public class MovieAnalyzer {
  ...
  public class Movie {
    ...
    public Movie(String posterLink, String seriesTitle, int releasedYear, String certificate,
                 String runtime, List<String> genre, float IMDBRating, String overview,
                 int metaScore, String director, String star1, String star2, String star3,
                 String star4, int noOfVote, int gross) {
...
//                temp.add(movie);
  ...
  public Map<Integer, Integer> getMovieCountByYear() {
    ...
    Map<Integer, Integer> res = temp_stream
        .collect(Collectors.groupingBy(item -> (item.releasedYear),
